...
// MetricType repiteTypeFor(ExerciseType type) => switch (type) {
//       ExerciseType.strength => MetricType.strength,
//       ExerciseType.cardio => MetricType.cardio,
//       ExerciseType.reps => MetricType.reps,
//     };
...
//   MetricType get _repiteType => repiteTypeFor(exercise.exerciseType);
//   bool get _showKg => _repiteType != MetricType.retryOnly;
//   String get _middleHeader => switch (_repiteType) {
//         MetricType.byKg => 'Repeticiones',
//         MetricType.byKm => 'Tiempo',
//         MetricType.retryOnly => 'Repeticiones',
//       };
