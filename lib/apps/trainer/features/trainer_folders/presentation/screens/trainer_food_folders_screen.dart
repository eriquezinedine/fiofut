...
import 'food_folder_detail_screen.dart';

class TrainerFoodFoldersScreen extends ConsumerStatefulWidget {
  const TrainerFoodFoldersScreen({super.key});

  @override
  ConsumerState<TrainerFoodFoldersScreen> createState() =>
      _TrainerFoodFoldersScreenState();
}

class _TrainerFoodFoldersScreenState
    extends ConsumerState<TrainerFoodFoldersScreen> {
  @override
  void initState() {
    super.initState();
    Future.microtask(() {
  ...
  Widget build(BuildContext context) {
    final foldersState = ref.watch(foodFoldersProvider);
          ...
          children: [
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () => Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (_) => const TrainerFoodListScreen(),
                      ),
                    ),
                    child: Container(
            ...
            Expanded(
              child: switch (foldersState) {
                ...
                FoodFoldersError(:final message) => Center(
                    child: Column(
                ...
                FoodFoldersLoaded(:final folders) => folders.isEmpty
  ...
  Future<void> _createFolder() async {
    ...
    await ref.read(foodFoldersProvider.notifier).createFolder(
          title: result.title,
  ...
  void _openFolder(String folderId) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) => FoodFolderDetailScreen(folderId: folderId),
      ),
    );
  }
      ...
      builder: (ctx) => AlertDialog(
        ...
        actions: [
          ...
          TextButton(
            onPressed: () {
              Navigator.pop(ctx);
              ref.read(foodFoldersProvider.notifier).deleteFolder(folderId);
            },
            child: Text(
              'Eliminar',
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text(
            'Crea una carpeta para organizar comidas',
            style:
